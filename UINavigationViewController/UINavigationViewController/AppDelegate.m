...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    product.tabBarItem.title = @"Product";
    nav.tabBarItem.image = [UIImage imageNamed:@"profile"];
    product.tabBarItem.image = [UIImage imageNamed:@"product"];
    about.tabBarItem.image = [UIImage imageNamed:@"about"];
